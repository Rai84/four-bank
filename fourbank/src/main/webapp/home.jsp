...
<body class="tema" id="home">
    ...
    <div class="parent_Home">
        ...
        <div class="saldo">
            <% if (conta != null) { %>
                <p>Seu saldo é: <%= conta.getSaldo() %></p>
            <% } else { %>
        ...
        <div class="emprestimo"></div>
        <div class="btns_principais"> 
            <div class="btn1"><a href="consultarExtrato.jsp">Consultar Extrato</a></div>
            <div class="btn2"><a href="fazerDeposito.jsp">Fazer Depósito</a></div>
            <div class="btn3"><a href="fazerEmprestimo.jsp">Fazer Empréstimo</a></div>
            <div class="btn4"><a href="sair.jsp">Sair</a></div>
        </div>
    </div>
